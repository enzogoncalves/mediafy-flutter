            ...
            return Scaffold(
              appBar: AppBar(
                ...
                actions: [
                  IconButton(
                    onPressed: () {
                      BlocProvider.of<AppCubit>(context).goToHomePage();            
                    }, 
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                children: [
                                  Text(
                                    movie.formatDate(movie.release_date!)["date"],
                                    style: const TextStyle(
                                      color: Colors.white
                                    ),
                                  ),
                                  ...
                                  Wrap(
                                    children: movie.formatGenres(movie.genres).split('').map((genre) {
                                      return Text(
                                        genre,
                                        style: const TextStyle(
                                          color: Colors.white
                                  ...
                                  Text(
                                    movie.formatMediaDuration(movie.runtime),
                                    style: const TextStyle(
                                      color: Colors.white
                                    ),
                                  ),
